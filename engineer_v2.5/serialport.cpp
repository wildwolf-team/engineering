...
SerialPort::SerialPort()
{
    ...
    const char *DeviceName[7] = {"", "/dev/ttyUSB0", "/dev/ttyUSB1", "/dev/ttyUSB2",
 ...
 *           Hzkkk
 */
void SerialPort::RMserialWrite(int16_t rect_x,int16_t rect_y,int16_t min_distance,int target_x)
{
    ...
    getDataForCRC(rect_x, rect_y,min_distance,target_x);
    // cout<<"distance:"<<min_distance<<endl;
    
    uint8_t CRC = Checksum_CRC8(g_CRC_buf, sizeof(g_CRC_buf));
    getDataForSend(rect_x,rect_y,min_distance,target_x,CRC);
    /*
    ...
    */
    ...
    // cout<<"dis:"<<min_distance<<"target_x:"<<target_x<<endl;
...
void SerialPort::getDataForCRC(int16_t rect_x,int16_t rect_y,int16_t min_distance,int target_x)
{
    g_CRC_buf[0] = 0x53;
...
void SerialPort::getDataForSend(int16_t rect_x,int16_t rect_y,int16_t min_distance,int target_x,uint8_t CRC)
{
    g_write_buf[0] = 0x53;
    ...
    g_write_buf[7] = target_x;
    g_write_buf[8] = CRC & 0xff;
    g_write_buf[9] = 0x45;
