...
{
    public:
    static int find_mineral(cv::Mat src_img_,int center_x,int num);
    static int lightAndMineral(cv::Mat src_img_);
    static int lightAndLight(Mat& tempframe,Mat& currentframe,Mat& previousframe,Mat& frame,int framenum);
    static int mineralAndMineral();
};
